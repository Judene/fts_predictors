...
from src.models.gru import GRURecurrentNN
...
# Create GRU model
gru_model = GRURecurrentNN(
    name="gru_currency_wf",
...
gru_predictions, gru_error = wf_model.train_and_predict(input_data, output_data)
