...
# Get gold data
gold_etf_data = pd.read_csv(r'C:\Users\ELNA SIMONIS\Documents\MEng\2021\Data\EditedData\Gold.csv', index_col=0)
...
pred_df.to_csv('C:/Users/ELNA SIMONIS/Documents/Results/Bitcoin_LR.csv')
