...
if __name__ == "__main__":
    ...
    input_data = zar_currency.drop(['Open','High','Low','Vol.','Change'], axis = 1)
    zar_currency = zar_currency.drop(['Open','High','Low','Vol.','Change'], axis = 1)
    
    #Hoe sa
    
    # Initiate our model
    model = WalkForwardPredictor(model=ARIMA(), start_date="2015-05-01", end_date="2021-04-01",
